...
print ('===============================================','\n')
print ('Learning resource: Urdu to English')
print ('===============================================','\n')
print ('This app will ask you for an Urdu word and show you the following things:\n')
print ('- the corresponding words in English\n')
print ('- how to pronounce these English words\n')
print ('- synonyms and related words for these English words\n')
#print ('- example sentences that use the English words\n\n')
word_id = input('Enter an Urdu word (in the Nastalikh script): ')
print ('\n')
print ('\n','===============================================','\n')
